...
const whatsappNumber = '9990018257';
...
export default function WhatsAppChatButton() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-16 h-16 bg-green-500 rounded-full shadow-lg hover:bg-green-600 transition-colors duration-300"
